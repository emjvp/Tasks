...
<div class="container-fluid">
	<form action="<?php echo $this->route."?contenido=".$this->contenido.""; ?>" method="post">
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="quienes_titulo" value="<?php echo $this->getObjectVariable($this->filters, 'quienes_titulo') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
    ...
    <div align="center">
	    ...
	    <?php
	        ...
	        if ($this->totalpages > 1) {
	            if ($this->page != 1)
	                echo '<li class="page-item" ><a class="page-link"  href="'.$url.'?page='.($this->page-1).'&contenido='.$this->contenido.'"> &laquo; Anterior </a></li>';
	            for ($i=1;$i<=$this->totalpages;$i++) {
	                if ($this->page == $i)
	                    echo '<li class="active page-item"><a class="page-link">'.$this->page.'</a></li>';
	                else
	                    echo '<li class="page-item"><a class="page-link" href="'.$url.'?page='.$i.'&contenido='.$this->contenido.'">'.$i.'</a></li>  ';
	            }
	            if ($this->page != $this->totalpages)
	                echo '<li class="page-item"><a class="page-link" href="'.$url.'?page='.($this->page+1).'&contenido='.$this->contenido.'">Siguiente &raquo;</a></li>';
	        }
	  	?>
	  	</ul>
	</div>
	<div class="content-dashboard">
	    <div class="franja-paginas">
		    <div class="row">
		    	...
		    	<div class="col-3">
		    		<div class="text-right"><a class="btn btn-sm btn-success" href="<?php echo $this->route."\manage"."?contenido=".$this->contenido.""; ?>"> <i class="fas fa-plus-square"></i> Crear Nuevo</a></div>
		    	</div>
		    </div>
	    </div>
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->quienes_id; ?>
					<tr>
						<td><?=$content->quienes_titulo;?></td>
						<td>
							  	...
							  	<div class="modal-dialog" role="document">
							    	<div class="modal-content">
								      ...
								      <div class="modal-footer">
								        	...
								        	<a class="btn btn-danger" href="<?php echo $this->route;?>/delete?id=<?= $id ?>&csrf=<?= $this->csrf;?><?php echo ''.'&contenido='.$this->contenido; ?>" >Eliminar</a>
								      </div>
							    	</div>
							  	</div>
							</div>
