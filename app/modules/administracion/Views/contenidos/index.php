        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
	                ...
	                <input type="text" class="form-control" name="contenidos_fecha" value="<?php echo $this->getObjectVariable($this->filters, 'contenidos_fecha') ?>"></input>
	                    </label>
	            </div>
				<div class="col-3">
					<label>Seccion</label>
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="contenidos_seccion">
	                        ...
	                        <?php foreach ($this->list_contenidos_seccion as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'contenidos_seccion') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="contenidos_estado">
	                        ...
	                        <?php foreach ($this->list_contenidos_estado as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'contenidos_estado') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="contenidos_titulo" value="<?php echo $this->getObjectVariable($this->filters, 'contenidos_titulo') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->contenidos_id; ?>
					<tr>
						<td><?=$content->contenidos_fecha;?></td>
						<td><?= $this->list_contenidos_seccion[$content->contenidos_seccion];?>
						<td><?= $this->list_contenidos_estado[$content->contenidos_estado];?>
						<td><?=$content->contenidos_titulo;?></td>
						<td>
						...
						<td class="text-right">
							<div>
							<a class="btn btn-verde btn-sm" href="/administracion/quienessomos?contenido=<?= $id ?>" data-toggle="tooltip" data-placement="top" title="Contenidos"><i class="fas fa-pen-alt"></i></a>
