        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="revista_titulo" value="<?php echo $this->getObjectVariable($this->filters, 'revista_titulo') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Imagen</label>
		            ...
		            <input type="text" class="form-control" name="revista_imagen" value="<?php echo $this->getObjectVariable($this->filters, 'revista_imagen') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Pdf</label>
		            ...
		            <input type="text" class="form-control" name="revista_pdf" value="<?php echo $this->getObjectVariable($this->filters, 'revista_pdf') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->revista_id; ?>
					<tr>
						<td><?=$content->revista_titulo;?></td>
						<td>
							<?php if($content->revista_imagen) { ?>
								<img src="/images/<?= $content->revista_imagen; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->revista_imagen; ?></div>
						</td>
						<td><?=$content->revista_pdf;?></td>
						<td>
