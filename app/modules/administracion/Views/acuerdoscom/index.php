	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="contenidos_sec_seccionid">
	                        ...
	                        <?php foreach ($this->list_contenidos_sec_seccionid as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'contenidos_sec_seccionid') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
			...
			<tbody>
				...
				<?php $id =  $content->contenidos_sec_id; ?>
					<tr>
						...
						<td><?= $this->list_contenidos_sec_seccionid[$content->contenidos_sec_seccionid];?>
						<td>
