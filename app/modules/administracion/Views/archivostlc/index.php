        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="archivostlc_titulo" value="<?php echo $this->getObjectVariable($this->filters, 'archivostlc_titulo') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->archivostlc_id; ?>
					<tr>
						<td><?=$content->archivostlc_titulo;?></td>
						<td>
