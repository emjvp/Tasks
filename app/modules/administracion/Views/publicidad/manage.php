    ...
    <form class="text-left" enctype="multipart/form-data" method="post" action="<?php echo $this->routeform;?>"
        ...
        <div class="content-dashboard">
            ...
            <div class="row">
                ...
                <div class="col-6 form-group">
                    <label for="banner_responsive">Imagen Responsive</label>
                    <input type="file" name="banner_responsive" id="banner_responsive" class="form-control  file-image"
                        data-buttonName="btn-primary" accept="image/gif, image/jpg, image/jpeg, image/png">
                    <div class="help-block with-errors"></div>
                    <?php if($this->content->banner_responsive) { ?>
                    <div id="imagen_banner_responsive">
                        <img src="/images/<?= $this->content->banner_responsive; ?>" class="img-thumbnail thumbnail-administrator" />
                        <div><button class="btn btn-danger btn-sm" type="button" onclick="eliminarImagen('banner_responsive','<?php echo $this->route."/deleteimage";
                                ?>')"><i class="glyphicon glyphicon-remove"></i> Eliminar Imagen</button></div>
                    </div>
                    <?php } ?>
                </div>
