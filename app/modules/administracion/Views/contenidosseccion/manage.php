		...
		<div class="content-dashboard">
			...
			<div class="row">
				<div class="col-12 form-group">
					<label for="contenidos_sec_titulo"  class="control-label">Titulo</label>
				...
				<div class="col-12 form-group">
					<label for="contenidos_sec_descripcion" class="form-label" >Descripcion</label>
				...
				<div class="col-12 form-group">
					<label class="control-label">Acuerdo Comercial rel</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono  fondo-rosado " ><i class="far fa-list-alt"></i></span>
						</div>
						<select class="form-control" name="seccion_id"   required>
							<option value="">Seleccione...</option>
							<?php foreach ($this->seccion AS $key => $seccion ){?>
								<option <?php if($this->getObjectVariable($this->content,"seccion_id") == $seccion->seccion_id ){ echo "selected"; }?> value="<?php echo $seccion->seccion_id; ?>" /> <?= $seccion->seccion_titulo; ?></option>
							<?php } ?>
						</select>
					</label>
					<div class="help-block with-errors"></div>
