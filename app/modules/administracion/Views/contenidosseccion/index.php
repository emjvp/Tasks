        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="contenidos_sec_titulo" value="<?php echo $this->getObjectVariable($this->filters, 'contenidos_sec_titulo') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
					<label>Acuerdo Comercial rel</label>
	                <label class="input-group">
						<div class="input-group-prepend">
	                    ...
	                    <select class="form-control" name="seccion_id">
	                        ...
	                        <?php foreach ($this->list_seccion_id as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'seccion_id') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="contenidos_sec_imagen" value="<?php echo $this->getObjectVariable($this->filters, 'contenidos_sec_imagen') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->contenidos_sec_id; ?>
					<tr>
						<td><?=$content->contenidos_sec_titulo;?></td>
						<td><?= $this->list_seccion_id[$content->seccion_id];?>
						<td>
							<?php if($content->contenidos_sec_imagen) { ?>
								<img src="/images/<?= $content->contenidos_sec_imagen; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->contenidos_sec_imagen; ?></div>
						</td>
						<td>
