...
class Administracion_contenidosController extends Administracion_mainController
{
			...
			if ($content->contenidos_id) {
				...
				if($_FILES['contenidos_archivo']['name'] != ''){
					if($content->contenidos_archivo){
						$uploadImage->delete($content->contenidos_archivo);
					}
					$data['contenidos_archivo'] = $uploadDocument->upload("contenidos_archivo");
				} else {
    ...
    protected function getFilter()
    {
        ...
        if (Session::getInstance()->get($this->namefilter)!="") {
            ...
            if ($filters->contenidos_imagen != '') {
                $filtros = $filtros." AND contenidos_imagen LIKE '%".$filters->contenidos_imagen."%'";
            }
            if ($filters->contenidos_archivo != '') {
                $filtros = $filtros." AND contenidos_archivo LIKE '%".$filters->contenidos_archivo."%'";
            }
    ...
    protected function filters()
    {
        if ($this->getRequest()->isPost()== true) {
            ...
            $parramsfilter = array();
					...
					$parramsfilter['contenidos_imagen'] =  $this->_getSanitizedParam("contenidos_imagen");
					$parramsfilter['contenidos_archivo'] =  $this->_getSanitizedParam("contenidos_archivo");
